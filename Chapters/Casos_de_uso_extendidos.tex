...
de qu\'e se hace, que actores toman parte, precondiciones, requisitos no 
funcionales, el flujo de
...
Tambi\'en se a\~nade aqu\'i el diagrama de casos de uso para que no haga falta
...
\begin{table}[H]
	\begin{center}
		...
		\begin{tabular}{|l*{1}{p{10cm}}|}
		    ...
		    Descripci\'on              & Abre uno o varios v\'ideos y los 
		    							 a\~nade al contenedor
		    ...
		    Flujo de eventos           & \begin{enumerate}
		    								...
		    								[\ref{fig:CargarVideo}]
		    								\item \textbf{Si el contenedor de 
		    								v\'ideos no estaba cargado}
	    									\begin{enumerate}
...
\begin{table}[H]
	\begin{center}
		...
		\begin{tabular}{|l*{1}{p{10cm}}|}
			...
			\multicolumn{2}{c}{\includegraphics[width=0.8\linewidth]{./Figures/CargarPropiedad.png}}
			 \\
			\hline
