...
El software, debe permitir cargar observaciones y propiedades previamente capturadas con diversas herramientas (Kinect) y
...
La herramienta ha de permitir visualizar los datos en bruto y en v\'{i}deo (si est\'a disponible). El fin de la herramienta es
...
\'agiles, como Scrum y Kanban que ser\'an detallados m\'as adelante. Pero se puede adelantar que al utilizar este tipo
de metodolog\'ias se hace frente a uno de los mayores problemas del desarrollo de software: la incertidumbre y los cambios
no contemplados inicialmente, as\'i como incrementar la productividad al ser m\'as sistem\'aticos.
\begin{figure}[h]
    \centering
...
en que consiste cada sprint. Hay que tener en cuenta que el contenido de
cada sprint es orientativo. Ser\'ia algo as\'i como la planificaci\'on \'optima, pero no es algo
que sea invariable.
...
\begin{equation}
Amortizacion \ a \ cargar (€) = 3.559,4775 * 0,583 = 2.075,17 €
\end{equation}
