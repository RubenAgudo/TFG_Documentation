...
por la universidad de Navarra y del grupo de investigaci\'on GALAN 
...
\begin{enumerate}
	\item Obtener la lista de tareas (Scrum backlog).
	\item Mientras haya tareas en el Scrum backlog.
	\begin{enumerate}
		\item Crear sprint backlog, es decir, las tareas de ese sprint.
		\item Programar las tareas del sprint.
		\item Reuni\'on de retrospectiva para ver qu\'e ha ido mal y mejorarlo.
...
Es fundamental que entre sprint y sprint el valor del producto haya aumentado. 
Lo importante es el producto, no el 
...
Por otro lado, si se comete alg\'un error ser\'a muy sencillo corregirlo ya que si los sprints son, por ejemplo, de dos semanas, no 
...
\subsection{Kanban}
Kanban es un m\'etodo de organizaci\'on del conocimiento del trabajo que se 
est\'a realizando, con un gran \'enfasis en la entrega justo a 
tiempo sin sobrecargar al equipo \cite{Kanban:WhatIsIt}.
...
\begin{table}[H]
    \begin{center}
        ...
        \begin{tabular}{l p{8cm}}
            ...
            Descripci\'{o}n                       & Realizar el diseño de 
            software, clases, Interfaces necesarias, qu\'e patrones van a 
            usarse etc 
...
\begin{table}[H]
    \begin{center}
        ...
        \begin{tabular}{l p{8cm}}
            Duraci\'{o}n (Horas / Persona)        & 1. \\ 
            Descripci\'{o}n                       & Entregar el ejecutable del 
            proyecto realizado. \\
...
Al seguirse una metodolog\'ia \'agil de desarrollo, la planificaci\'on se ha
...
que no se termina, no se elige qu\'e se va a hacer en el segundo, aumentando la 
flexibilidad a 
...
\begin{itemize}
    \item Crear el control de cargar v\'{i}deos (contenedor de v\'{i}deos). El 
    contenedor debe 
    permitir:
    \begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        propiedades.
        \item Que muestre el progreso, y que est\'e sincronizado con el 
        v\'{i}deo.
...
\begin{itemize}
    ...
    software ULISES, en el que MIPS ser\'a integrado, est\'a desarrollado 
    usando Visual Studio, se ha utilizado por 
...
\begin{table}[H]
    \begin{center}
        \rowcolors{1}{lightgray}{} %\rowcolors{<starting row index>}{<odd row color>}{<even row color>}
        \begin{tabular}{l p{8cm}}
            Descripci\'{o}n                 & Al utilizar dos ordenadores, una 
            workstation y un port\'{a}til, puede que no se
...
\begin{table}[H]
    \begin{center}
        ...
        \begin{tabular}{l p{8cm}}
            ...
            Plan de contingencia            & Blindar las caracter\'{i}sticas, 
            solo se realizar\'an las estipuladas durante el 
            							   	  proyecto. \\
            Probabilidad                    & Probable \\
            Impacto                         & Muy alto \\
        \end{tabular}
...
\begin{table}[H]
    \begin{center}
        \rowcolors{1}{lightgray}{} %\rowcolors{<starting row index>}{<odd row color>}{<even row color>}
        \begin{tabular}{l p{8cm}}
            Descripci\'{o}n                 & Los  programadores  al tener  un  
            conocimiento
    ...
    \begin{center}
        ...
        \begin{tabular}{l p{8cm}}
            ...
            Plan de contingencia            & Evaluar los nuevos requisitos para saber si se pueden
            								  abordar o no y si fuese que s\'i, 
            								  estudiar la situación y 
            								  realizarlo. \\
            Probabilidad                    & Probable \\
            Impacto                         & Alto \\
        \end{tabular}
...
Por lo tanto el coste de MIPS ser\'a de 0€.
...
para cobrar de manera correcta por ese desgaste. Este factor se le aplicar\'a 
tanto al software de pago como
...
El portátil est\'a pensado para ser amortizado en 8 años.
